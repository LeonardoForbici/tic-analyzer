...
function pushEdge(edges: GraphEdge[], edgeKeys: Set<string>, from: string, to: string, type: GraphEdgeType, sourcePath: string, targetPath: string): void {
...
function plsqlType(kind: string): string {
  return {
