...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerTreeDataProvider('ticCoderLite.sidebar', provider), vscode.commands.registerCommand('ticCoderLite.refreshSidebar', () => provider.refresh()), vscode.commands.registerCommand('ticCoderLite.analyzeProject', async () => {
        ...
        provider.refresh();
    }), vscode.commands.registerCommand('ticCoderLite.openOverview', () => (0, openOverview_1.openOverview)(context)), vscode.commands.registerCommand('ticCoderLite.generateAgentContext', () => (0, generateAgentContext_1.generateAgentContext)(context)), vscode.commands.registerCommand('ticCoderLite.exportAgentsMd', () => (0, exportAgentsMd_1.exportAgentsMd)(context)), vscode.commands.registerCommand('ticCoderLite.detectAiEngines', () => (0, exportForEngines_1.detectAiEnginesCommand)()), vscode.commands.registerCommand('ticCoderLite.exportForCodex', () => (0, exportForEngines_1.exportForEngineCommand)(context, 'codex')), vscode.commands.registerCommand('ticCoderLite.exportForClaude', () => (0, exportForEngines_1.exportForEngineCommand)(context, 'claude-code')), vscode.commands.registerCommand('ticCoderLite.exportForCopilot', () => (0, exportForEngines_1.exportForEngineCommand)(context, 'github-copilot')), vscode.commands.registerCommand('ticCoderLite.exportForCursor', () => (0, exportForEngines_1.exportForEngineCommand)(context, 'cursor')), vscode.commands.registerCommand('ticCoderLite.exportForGemini', () => (0, exportForEngines_1.exportForEngineCommand)(context, 'gemini-cli')), vscode.commands.registerCommand('ticCoderLite.enhanceWithLocalAi', () => (0, enhanceWithLocalAi_1.enhanceWithLocalAi)()));
}
function deactivate() {
